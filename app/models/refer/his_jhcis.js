...
class HisJhcisModel {
    ...
    getReferOut(db, date, hospCode = hcode) {
        return db('hospdata.refer_out as refer')
            ...
            .select('refer.refer_hcode as hosp_destination', 'refer.hn', 'pt.person_id as cid', 'refer.vn as seq', 'refer.an', 'pt.title as prename', 'pt.name as fname', 'pt.surname as lname', 'pt.birth as dob', 'pt.sex', 'refer.icd10 as dx')
...
//# sourceMappingURL=his_jhcis.js.map